...
namespace CertificadorWs
{
    ...
    public class Constantes
    {
                ...
                var result = new Dictionary<int, string>
                                 {
                                     ...
                                     {399, "El CSD del emisor es inválido"},
                                     ...
                                     {1201, "UUID Cancelado exitosamente"},
                                     {1202, "UUID Previamente cancelado"},
                                     {1205, "UUID No encontrado"},
                                     {001, "Error General en el sistema, verificar el Log de la aplicación"},
                                     {1001, "Autenticación no válida"},
                                     {1002, "versión del estándar no existente"},
                                     {1003, "La estructura del comprobante recibido no es válida."},
        ...
        public static XNamespace RetencionNamesPace
        {
            get { return XNamespace.Get("http://www.sat.gob.mx/esquemas/retencionpago/1"); }
        }
                ...
                var result = new List<string>
                                 {
                                     ...
                                     "TuristaPasajeroExtranjero.xsd",
                                     "ventavehiculos11.xsd", "nomina11.xsd"
                                 };
