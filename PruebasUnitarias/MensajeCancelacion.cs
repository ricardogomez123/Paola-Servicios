...
namespace ServicioLocalContract
{
    public class MensajeCancelacion
    {
        ...
        public string CerarMensajeCancelacion(List<string> folios, string rfcEmisor, string rutaLLave, string rutaCert,
                                              string password)
        {
            try
            {
                ...
                SignXmlFile(str, ref strPXmlFirmado,
                            OpensslKey.DecodePrivateKey(File.ReadAllBytes(rutaLLave), password,""));
